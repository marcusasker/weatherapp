// Dessa variablerna hämtar in vad som finns i respesktive element som den pekar på och en lista som används i de olika funktionerna
...
getFromLocalStorage();// Dessa variablerna hämtar in vad som finns i respesktive element som den pekar på och en lista som används i de olika funktionerna
const searchForm = document.querySelector('#searchForm');
const searchInput = document.querySelector('#searchInput');
const searchItemsList = document.querySelector('#searchList');
let searches = [];
